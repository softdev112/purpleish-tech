...
try {
    ...
    $mail->Host       = 'smtp.purpleishtech.com';                     //Set the SMTP server to send through
    $mail->SMTPAuth   = true;                                   //Enable SMTP authentication
    $mail->Username   = 'contact@purpleishtech.com';                     //SMTP username
    $mail->Password   = 'secret';                               //SMTP password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;         //Enable TLS encryption; `PHPMailer::ENCRYPTION_SMTPS` encouraged
    $mail->Port       = 587;                                    //TCP port to connect to, use 465 for `PHPMailer::ENCRYPTION_SMTPS` above

    //Recipients
    $mail->setFrom('contact@purpleishtech.com', 'Mailer');
    $mail->addAddress('contact@purpleishtech.com', 'Contact');     //Add a recipient
    $mail->addAddress('contact@purpleishtech.com');               //Name is optional
    $mail->addReplyTo('contact@purpleishtech.com', 'Information');
    $mail->addCC('contact@purpleishtech.com');
    $mail->addBCC('contact@purpleishtech.com');
